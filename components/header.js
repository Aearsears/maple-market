    ...
    render() {
        return (
			...
			<div className="container mx-auto md:flex justify-between items-center">
				<a href="#" className="block py-2 w-full text-center md:text-left md:w-auto text-gray-600 no-underline flex justify-center items-center">
					Maple Market
				</a>
				<Image
				src={mushPic} alt="Maplemarket logo"
				height="32"
				width = "32"
				/>
